...
public class Textcolor  extends QRAttribute{
	private QRWebPageEditorView fa;
	private String id;
	public Textcolor(Element element) {
		super(element);
		setName("Text color");
		setProperty(".style.color");
		if(hasStyleAttribute("color")){
			setAttribute(getStyleAttribute("color"));
		}else{
			setAttribute("");
	...
	public void onTouch(QRWebPageEditorView fa, String id) {
		...
		okColor.setOnClickListener(new View.OnClickListener() {
		    ...
		    public void onClick(View v) {
		    	...
		    	String style = editStyleAttribute("color", "#"+color.toUpperCase());
