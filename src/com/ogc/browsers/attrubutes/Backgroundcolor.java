...
public class Backgroundcolor  extends QRAttribute{
	private QRWebPageEditorView fa;
	private String id;
	public Backgroundcolor(Element element) {
		super(element);
		setName("Background color");
		setProperty(".style.background");
		if(hasStyleAttribute("background-color")){
			setAttribute(getStyleAttribute("background-color"));
		}else{
			setAttribute("");
	...
	public void onTouch(QRWebPageEditorView fa, String id) {
		...
		okColor.setOnClickListener(new View.OnClickListener() {
		    ...
		    public void onClick(View v) {
		    	...
		    	String style = editStyleAttribute("background-color", "#"+color.toUpperCase());
